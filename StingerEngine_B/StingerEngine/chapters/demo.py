...
script_data = [
    ...
    {"type": "character_enter", "id": "alex", "image": "textures/modTextures/demo/char_alex_angry", "position": "center", "fade_in": 0.3},
    ...
    {"type": "character_update", "id": "alex", "image": "textures/modTextures/demo/char_alex_normal", "transition": 0.2},
    ...
    {"type": "character_update", "id": "alex", "image": "textures/modTextures/demo/char_alex_blush", "transition": 0.3},
    {"type": "text", "speaker": "爱丽克丝", "content": "哎？突然说、说什么呢……快点换衣服啦，笨蛋。"},
    {"type": "jump", "target": "pre_mining"},

    # ---------------- 准备下矿 ----------------
    {"type": "label", "name": "pre_mining"},
    {"type": "character_update", "id": "alex", "image": "textures/modTextures/demo/char_alex_smile", "transition": 0.2},
    ...
    {"type": "character_show", "id": "alex", "image": "textures/modTextures/demo/char_alex_normal", "position": "center"},
